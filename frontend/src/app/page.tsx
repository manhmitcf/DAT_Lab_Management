  ...
  return (
    <div className="flex h-screen w-full min-h-0 bg-[#101922] text-white">
      ...
      <div className="flex min-w-0 flex-1 flex-col min-h-0 overflow-hidden">
        <header className="z-50 flex min-h-12 shrink-0 flex-wrap items-center gap-x-4 gap-y-2.5 border-b border-[#2a3441] bg-[#1B2431] px-3.5 py-2.5 sm:gap-x-5 sm:px-5 sm:py-3 md:gap-x-6 md:px-6 overflow-x-auto overscroll-x-contain [scrollbar-width:thin]">
          <SidebarHamburger />
          <div className="mx-1 h-6 w-px shrink-0 bg-[#2a3441] sm:mx-1.5" aria-hidden />
          <div className="flex items-center gap-2 sm:gap-2.5 shrink-0 rounded-md px-1.5 py-0.5 sm:px-2">
          ...
          <div className="mx-1 hidden h-6 w-px shrink-0 bg-[#2a3441] sm:mx-1.5 sm:block" aria-hidden />
          <div className="hidden sm:flex items-center gap-2 sm:gap-2.5 shrink-0 rounded-md px-1.5 py-0.5 sm:px-2">
          ...
          <Link
            ...
            className="flex items-center gap-2 sm:gap-2.5 shrink-0 rounded-md px-1.5 py-0.5 sm:px-2 text-white/90 hover:bg-white/5 hover:text-white transition-colors"
          >
          ...
          <div className="mx-1 hidden h-6 w-px shrink-0 bg-[#2a3441] md:mx-1.5 md:block" aria-hidden />
          <div className="hidden shrink-0 md:block md:pl-1.5">
            <MiniOccupancyChart />
          </div>
        </header>
